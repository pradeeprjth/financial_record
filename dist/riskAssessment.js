...
const riskAssessmentHandler = (event) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        // Step 1: Enrich the data
        const enrichmentResponse = yield (0, dataEnrichment_1.dataEnrichmentHandler)(event);
