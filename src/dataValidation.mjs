...
var dataValidationHandler = function (event) { return __awaiter(void 0, void 0, void 0, function () {
    var requestData, transactionDetails, userDetails;
    return __generator(this, function (_a) {
        try {
            ...
            transactionDetails = requestData.transactionDetails, userDetails = requestData.userDetails;
